		...
		<div class="detail">
			...
			<div class="detail_k">
				...
				<form action="ziliao.jsp" method="post" name="registerForm"
					...
					<div id="shuru">
						<label>姓&nbsp&nbsp&nbsp&nbsp名:</label> <input type="text"
							name="name" required placeholder="请输入真实姓名" class="height" />
					</div>
					<br>
					...
					<div id="shuru">
						<label>出生日期:</label> <input type="text" class="Wdate"
							name="i_date" onfocus="WdatePicker({lang:'zh-cn',})" />
					</div>
					<br>

					<div id="shuru">
						<label>联系电话:</label> <input type="text" name="phone" required
							placeholder="请输入您的电话号码" onkeyup="return teleIsOk()"
							class="height" /> <span id="phoneIsOk"></span>
					</div>
					<br>

					<div id="shuru">
						<label>联系地址:</label> <input type="text" name="address" required
							placeholder="请输入您的详细地址" class="height" />
					</div>
					<br> <input type="submit" value=" 确认修改" class="button">
				</form>
