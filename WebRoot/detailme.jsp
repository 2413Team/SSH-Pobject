		...
		<div class="table" >
			...
			<s:iterator value="uoList" id="uolist">			
				<div style="float: left; margin-right: 50px;">
					...
					<a style="float: right; display:block; margin-top: 150px; margin-left: -150px; color:white;" href="quitOrganization.action?organizationid=${uolist.organization.id}" >退出</a>
				</div>
			</s:iterator>
			</s:if>
			<s:else>
